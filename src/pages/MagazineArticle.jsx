      ...
      <div className="container mx-auto px-4">
        ...
        <AnimatedElement animation="fadeIn" className="mb-12">
          <div className="max-w-4xl mx-auto">
            {/* Category Badge */}
            <div className="mb-6">
              <span className="px-4 py-2 bg-secondary-500/20 text-secondary-700 rounded-full text-sm font-medium">
                {rtl ? 'מאמר' : 'Article'}
              </span>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="inline-flex items-center gap-2 px-4 py-2 bg-secondary-500 hover:bg-secondary-600 text-white rounded-lg transition-colors">
        ...
        <AnimatedElement animation="fadeIn" className="mb-16">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card rounded-2xl p-8 md:p-12 border border-neutral-200">
              <div
                    ...
                    <Link to={createPageUrl('MagazineArticle').replace('magazinearticle', `magazine/${relatedArticle.id}`) + `?lang=${language}`}>
                      ...
                      <div className="p-6">
                        <div className="flex items-center gap-2 mb-3">
                          <span className="px-3 py-1 bg-secondary-500/20 text-secondary-700 rounded-full text-sm font-medium">
                            {rtl ? 'מאמר' : 'Article'}
                          </span>
                        ...
                        <p className="text-neutral-700 mb-4 line-clamp-3 text-sm">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-secondary-700 group-hover:text-secondary-400 transition-colors text-sm font-medium">
